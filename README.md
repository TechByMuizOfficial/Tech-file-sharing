...
[![Deploy to Koyeb](https://www.koyeb.com/static/images/deploy/button.svg)](https://app.koyeb.com/deploy?type=git&repository=github.com/TechByMuizOfficial/Tech-file-sharing&branch=main&name=file-sharing-bot)

### Deploy on Your VPS

```bash
git clone https://github.com/TechByMuizOfficial/Tech-file-sharing
...
### 💬 Support
Join Our [Telegram Group](https://www.telegram.dog/Tech_Muiz_Official_Chat) For Support/Assistance And Our [Channel](https://www.telegram.dog/Tech_Muiz_Official) For Updates.   
   
Report Bugs, Give Feature Requests There..   

### 🎉 Credits

- Thanks to Tech Muiz for Modified this repo
